import { MessageFormat, type MessagePart, type MessageLiteralPart, type MessageMarkupPart } from 'messageformat'
...
function HetListToDOMTree(
	...
	return hetList.flatMap((part) => {
		...
		if (Markup.isMarkup(part)) {
			...
			return component ? React.cloneElement(component, undefined, ...subtree) : subtree;
		}
